...
public static class FileNameHelper
{
    ...
    /// <summary>
    ///     Generates a cache file name for LRC files using the "Artist - Title.lrc" format.
    /// </summary>
    /// <param name="artist">The artist name.</param>
    /// <param name="title">The song title.</param>
    /// <returns>A sanitized file name in the format "Artist - Title.lrc".</returns>
    public static string GenerateLrcCacheFileName(string? artist, string? title)
    {
