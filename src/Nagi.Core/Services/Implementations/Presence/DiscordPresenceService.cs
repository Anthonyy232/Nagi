...
public class DiscordPresenceService : IPresenceService, IAsyncDisposable {
    ...
    private void OnRpcError(object sender, DiscordRPC.Message.ErrorMessage e) {
    ...
    public Task OnPlaybackStateChangedAsync(bool isPlaying) {
        ...
        _logger.LogInformation("Updating Discord presence for playback state change. IsPlaying: {IsPlaying}", isPlaying);
