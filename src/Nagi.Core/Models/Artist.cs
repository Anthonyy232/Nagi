...
public class Artist
{
    ...
    /// </summary>
    [MaxLength(50000)] public string? Biography { get; set; }

    /// <summary>
    ///     The remote URL of the artist's image.
    /// </summary>
    [MaxLength(2000)] public string? RemoteImageUrl { get; set; }

    /// <summary>
    ///     The local file path to the cached artist image.
    /// </summary>
    [MaxLength(1000)] public string? LocalImageCachePath { get; set; }
