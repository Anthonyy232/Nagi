...
public sealed partial class GenrePage : Page
{
    ...
    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        if (ViewModel.Genres.Count == 0) await ViewModel.LoadGenresAsync(_cancellationTokenSource.Token);
    }
    ...
    {
        if (e.ClickedItem is GenreViewModelItem clickedGenre) ViewModel.NavigateToGenreDetail(clickedGenre);
    }
}