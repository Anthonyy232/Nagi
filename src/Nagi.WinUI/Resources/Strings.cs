...
public static class Strings
{
    ...
    public static string QueueFlyout_ClearQueue => GetString("QueueFlyout_ClearQueue");
    public static string QueuePanel_DisplayOptions => GetString("QueuePanel_DisplayOptions");
    public static string QueuePanel_Close => GetString("QueuePanel_Close");
    public static string QueuePanel_ShowArtist => GetString("QueuePanel_ShowArtist");
    public static string QueuePanel_ShowDuration => GetString("QueuePanel_ShowDuration");
    public static string QueuePanel_ShowTrackCount => GetString("QueuePanel_ShowTrackCount");
    public static string QueuePanel_ShowPosition => GetString("QueuePanel_ShowPosition");
    public static string QueuePanel_ShowGenre => GetString("QueuePanel_ShowGenre");
    public static string QueuePanel_ShowTotalDuration => GetString("QueuePanel_ShowTotalDuration");
    public static string QueuePanel_Play => GetString("QueuePanel_Play");
    public static string QueuePanel_MoveUp => GetString("QueuePanel_MoveUp");
    public static string QueuePanel_MoveDown => GetString("QueuePanel_MoveDown");
    public static string QueuePanel_Remove => GetString("QueuePanel_Remove");
    public static string QueuePanel_TrackCount => GetString("QueuePanel_TrackCount");
    ...
    public static string SettingsPage_RomanizedLyrics_Header => GetString("SettingsPage_RomanizedLyrics_Header");
    public static string SettingsPage_RomanizedLyrics_Description => GetString("SettingsPage_RomanizedLyrics_Description");
    public static string SettingsPage_RomanizationPacks_Header => GetString("SettingsPage_RomanizationPacks_Header");
    public static string SettingsPage_RomanizationPacks_Description => GetString("SettingsPage_RomanizationPacks_Description");
    public static string SettingsPage_RomanizationPacks_Refresh => GetString("SettingsPage_RomanizationPacks_Refresh");
    public static string SettingsPage_RomanizationPacks_Install => GetString("SettingsPage_RomanizationPacks_Install");
    public static string SettingsPage_RomanizationPacks_Update => GetString("SettingsPage_RomanizationPacks_Update");
    public static string SettingsPage_RomanizationPacks_Remove => GetString("SettingsPage_RomanizationPacks_Remove");
    public static string SettingsPage_RomanizationPacks_None => GetString("SettingsPage_RomanizationPacks_None");
    public static string SettingsPage_RomanizationPacks_LoadFailedFormat => GetString("SettingsPage_RomanizationPacks_LoadFailedFormat");
    public static string SettingsPage_RomanizationPacks_InstallFailed => GetString("SettingsPage_RomanizationPacks_InstallFailed");
    public static string SettingsPage_RomanizationPacks_RemoveFailed => GetString("SettingsPage_RomanizationPacks_RemoveFailed");
    public static string SettingsPage_RomanizationPack_UpdateAvailable => GetString("SettingsPage_RomanizationPack_UpdateAvailable");
    public static string SettingsPage_RomanizationPack_InstalledFormat => GetString("SettingsPage_RomanizationPack_InstalledFormat");
    public static string SettingsPage_RomanizationPack_NotInstalled => GetString("SettingsPage_RomanizationPack_NotInstalled");
    public static string SettingsPage_RomanizationPack_LicenseFormat => GetString("SettingsPage_RomanizationPack_LicenseFormat");
