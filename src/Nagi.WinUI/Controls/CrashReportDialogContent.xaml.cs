...
namespace Nagi.WinUI.Controls {
    ...
    public sealed partial class CrashReportDialogContent : UserControl {
        public static readonly DependencyProperty IntroductionProperty =
            DependencyProperty.Register(nameof(Introduction), typeof(string), typeof(CrashReportDialogContent), new PropertyMetadata(string.Empty));

        public static readonly DependencyProperty LogContentProperty =
            DependencyProperty.Register(nameof(LogContent), typeof(string), typeof(CrashReportDialogContent), new PropertyMetadata(string.Empty));

        public static readonly DependencyProperty GitHubUrlProperty =
            DependencyProperty.Register(nameof(GitHubUrl), typeof(string), typeof(CrashReportDialogContent), new PropertyMetadata(string.Empty));
        ...
        private async void CopyButton_Click(object sender, RoutedEventArgs e) {
            ...
            dataPackage.SetText(this.LogContent);
