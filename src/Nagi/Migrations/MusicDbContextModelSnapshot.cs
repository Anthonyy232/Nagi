...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nagi.Models.Album", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nagi.Models.Artist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nagi.Models.Folder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nagi.Models.Genre", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nagi.Models.ListenHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Nagi.Models.Playlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Nagi.Models.PlaylistSong", b =>
                {
            ...
            modelBuilder.Entity("Nagi.Models.Song", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("GenreSong", b =>
                {
                    b.HasOne("Nagi.Models.Genre", null)
                        .WithMany()
                        .HasForeignKey("GenresId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nagi.Models.Song", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nagi.Models.Album", b =>
                {
                    b.HasOne("Nagi.Models.Artist", "Artist")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("Nagi.Models.ListenHistory", b =>
                {
                    b.HasOne("Nagi.Models.Song", "Song")
            ...
            modelBuilder.Entity("Nagi.Models.PlaylistSong", b =>
                {
                    b.HasOne("Nagi.Models.Playlist", "Playlist")
            ...
            modelBuilder.Entity("Nagi.Models.Song", b =>
                {
                    b.HasOne("Nagi.Models.Album", "Album")
                        .WithMany("Songs")
                    ...
                    b.HasOne("Nagi.Models.Folder", "Folder")
                        .WithMany("Songs")
